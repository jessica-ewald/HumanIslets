...
# Jessica Ewald
# From the October 12, 2022 script; adapted Feb 13, 2023 for updated dataset; adapted Apr 25 for web-tool
...
saveRDS(prot, "/Users/jessicaewald/Desktop/prot_imputed.rds") # save copy in case of an issue in the following steps
...
# write out results
write.csv(prot, "/Users/jessicaewald/Library/CloudStorage/OneDrive-McGillUniversity/XiaLab/Tools/HumanIslets/Omics_data/proc/proc_prot.csv")
